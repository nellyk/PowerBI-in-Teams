...
console.log("config.powerBI.workspaceId", config.powerBI.workspaceId);
/**
...
async function getEmbedInfo() {
    ...
    try {
        ...
        const embedParams = await getEmbedParamsForSingleReport(config.powerBI.workspaceId, config.powerBI.reportId);
